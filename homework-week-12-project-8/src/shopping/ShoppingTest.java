...
public class ShoppingTest extends Utility {
    ...
    public void verifyThatUserShouldPlaceOrderSuccessfullyForOllieTheAppControlledRobot() throws InterruptedException {
        ...
        setTextToElement(By.xpath("//input[@id='email']"), "Test@domain.be");   // 1.14 Enter Email address
        ...
        Timestamp timestamp = new Timestamp(System.currentTimeMillis()); // To generate a new dummy email
        String emailAddress = "mark" + timestamp.getTime() + "@domain.com";// To generate a new dummy email
        setTextToElement(By.xpath("//input[@id='email']"), emailAddress);// To generate a new dummy email

        clickOnElement(By.xpath("//input[@id='create_profile']")); // 1.18 Check the check box “Create an account for later use”
        setTextToElement(By.xpath("//input[@id='password']"), "Password123"); //1.19 Enter the password
