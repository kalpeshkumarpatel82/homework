...
public class HotDealsTest extends Utility {
    ...
    public void verifySaleProductsArrangeAlphabetically() throws InterruptedException {
        ...
        mouseHover(By.xpath("//div/ul[@class='nav navbar-nav top-main-menu']//li[@class='leaf has-sub']//ul/li/a/span"));
        clickOnElement(By.xpath("//div/ul[@class='nav navbar-nav top-main-menu']//li[@class='leaf has-sub']//ul/li/a/span"));
